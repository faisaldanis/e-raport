        ...
        <div class="row">
          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="1B" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>NIS</th>
                  <th>Nama Siswa</th>
              ...
              <a href="kelas_1b.php" class="btn btn-danger mt-2">Lihat Lebih Banyak Data . . . . .</a>
              </div><!-- /.card-body -->
            </div>
            <!-- /.card -->
          </section>
