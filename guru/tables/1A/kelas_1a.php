              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <?php
                    ...
                    $sql = mysqli_query($connect, "SELECT * FROM siswa where kode_kelas='1A'");
                        ...
                        foreach ($sql as $data) {
                          ...
                          echo "<td><center><a href='detail.php?nis=$data[nis]' class='btn btn-primary '> <i class='fa fa-paper-plane'></i>  Nilail</a></center></td>";
                          echo "</tr>";
                        }
