        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../tables/tables/4A/" class="nav-link">
              ...
              <form role="form" action="proses.php" method="POST">
                <div class="card-body text-dark">
                  <div class="form-group">
                      ...
                      <option value="3A">Kelas 5A</option>
                      <option value="3B">Kelas 5B</option>
                      <option value="4A">Kelas 6A</option>
                      <option value="4B">Kelas 6B</option>
	                  </select>
	              </div>
                  ...
                  <?php 
                    ...
                    $sql = mysqli_query($connect, "SELECT * from kelas");
                        ...
                        foreach ($sql as $data) {
                          ...
                          echo "<td><center><a href='delete.php' class='btn btn-danger'>Hapus</a></center></td>";
                          echo "</tr>";
                        }
