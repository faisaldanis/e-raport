            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3>
                  ...
                  <?php
                    $data_siswa = mysqli_query($connect, "SELECT * from siswa where jenis_kelamin='L'");  
                    $hitung = mysqli_num_rows($data_siswa);
                    echo "<b style='font-size: 50px';>$hitung </b>";
                  ?>
                    
                </h3>
                <h4 class="text-white">Jumlah Siswa Laki-Laki</h4>
              </div>
              <div class="icon">
                <i class="ion ion-person"></i>
              </div>
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3>
                  ...
                  <?php
                    $data_siswa = mysqli_query($connect, "SELECT * from siswa where jenis_kelamin='P'");  
                    $hitung = mysqli_num_rows($data_siswa);
                    echo "<b style='font-size: 50px';>$hitung </b>";
                  ?>
                    
                </h3>
                <h4>Jumlah Siswa Perempuan</h4>
              </div>
              <div class="icon">
                <i class="ion ion-person"></i>
              </div>
            ...
            <div class="small-box bg-dark">
              <div class="inner">
                <h3>
                  ...
                  <?php
                    $data_guru = mysqli_query($connect, "SELECT * from guru");  
                    $hitung = mysqli_num_rows($data_guru);
                    echo "<b style='font-size: 50px';>$hitung </b>";
                  ?>
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3>
                  ...
                  <?php
                    $data_guru = mysqli_query($connect, "SELECT * from guru where jenis_kelamin='L'");  
                    $hitung = mysqli_num_rows($data_guru);
                    echo "<b style='font-size: 50px';>$hitung </b>";
                  ?>
                    
                </h3>
                <h4>Jumlah Guru Laki-Laki</h4>
              </div>
              <div class="icon">
                <i class="ion ion-person"></i>
              </div>
            ...
            <div class="small-box bg-primary">
              <div class="inner">
                <h3>
                  ...
                  <?php
                    $data_guru = mysqli_query($connect, "SELECT * from guru where jenis_kelamin='P'");  
                    $hitung = mysqli_num_rows($data_guru);
                    echo "<b style='font-size: 50px';>$hitung </b>";
                  ?>
                    
                </h3>
                <h4>Jumlah Guru Perempuan</h4>
              </div>
              <div class="icon">
                <i class="ion ion-person"></i>
              </div>
