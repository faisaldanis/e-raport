        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="kelas_3b.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0 text-dark">Dashboard Kelas 3B</h3>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Dashboard 3B</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3>
                  ...
                  <?php
                    $data_siswa = mysqli_query($connect, "SELECT * from siswa where jenis_kelamin='laki-laki' and kode_kelas='3B'");  
                    $hitung = mysqli_num_rows($data_siswa);
                    echo "<b style='font-size: 50px';>$hitung </b>";
                  ?>
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3>
                  ...
                  <?php
                    $data_siswa = mysqli_query($connect, "SELECT * from siswa where jenis_kelamin='perempuan' and kode_kelas='3B'");  
                    $hitung = mysqli_num_rows($data_siswa);
                    echo "<b style='font-size: 50px';>$hitung </b>";
                  ?>
              ...
              <div class="card-body">
                ...
                <tr>
                  <?php 
                    ...
                    $sql = mysqli_query($connect, "SELECT nis, nama_siswa, jenis_kelamin, kode_kelas FROM siswa where kode_kelas='3B' ORDER BY nis asc limit 10");
