              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <?php
                    ...
                    $sql = mysqli_query($connect, "SELECT * FROM siswa ORDER BY nis asc");
                        ...
                        foreach ($sql as $data) {
                          ...
                          echo "<td><center><a href='hapus.php?nis=$data[nis]' class='btn btn-danger mr-1'> <i class='fa fa-trash'></i>  Hapus</a><a href='edit.php?nis=$data[nis]' class='btn btn-success '> <i class='fas fa-edit'></i>  Edit</a></center></td>";
                          echo "</tr>";
                        }
