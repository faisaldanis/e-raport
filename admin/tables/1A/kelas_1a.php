              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <?php
                    ...
                    $sql = mysqli_query($connect, "SELECT * FROM siswa where kode_kelas='1A' ORDER BY nis asc");
                        ...
                        foreach ($sql as $data) {
                          ...
                          echo "<td><center><a href='detail.php?nis=$data[nis]' class='btn btn-primary mr-1 button1'> <i class='fa fa-paper-plane'></i> Detail</a><a href='hapus.php?nis=$data[nis]' class='btn btn-danger mr-1 button1'> <i class='fa fa-trash'></i> Hapus</a><a href='../edit.php?nis=$data[nis]' class='btn btn-success button1'> <i class='fas fa-edit'></i> Edit</a></center></td>";
                          echo "</tr>";
                        }
