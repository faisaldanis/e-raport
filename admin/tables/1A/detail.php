          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped table-hover">
                <?php 
                $nis = $_GET['nis'];
                $sql = mysqli_query($connect,"SELECT guru.nama_guru as nama_guru, kelas.kode_kelas as kode_kelas, siswa.nama_siswa as nama_siswa, mata_pelajaran.nama_mapel as nama_mapel, penilaian.nis as nis, penilaian.kode_mapel as kode_mapel, penilaian.kategori_nilai as kategori_nilai, penilaian.nilai as nilai from guru join kelas on guru.kode_kelas=kelas.kode_kelas join siswa on kelas.kode_kelas=siswa.kode_kelas join penilaian on siswa.nis=penilaian.nis join mata_pelajaran on penilaian.kode_mapel=mata_pelajaran.kode_mapel where penilaian.nis=$nis");
                  foreach ($sql as $data){
                    $nis = $data['nis'];
                ...
                ?>
                  ...
                  <li class="list-group-item bg-light"><b>Nama Siswa</b><span style="padding-left: 6.2em;"></span> : <span style="padding-left: 3em;"></span><?php echo "$nama_siswa"; ?></li>
                  ...
                  <li class="list-group-item bg-light"><b>Wali Kelas</b><span style="padding-left: 7.1em;"></span> : <span style="padding-left: 3em;"></span><?php echo "$nama_guru"; ?></li>
