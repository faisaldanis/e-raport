  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0 text-dark">Input Data Siswa</h3>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <section class="col-lg-5 connectedSortable">
            ...
            <div class="card bg-gradient-info">
              ...
              <?php 
                $nis = $_GET['nis'];
                $sql = mysqli_query($connect,"SELECT siswa.nis as nis, siswa.nama_siswa as nama_siswa, siswa.jenis_kelamin as jenis_kelamin, siswa.alamat as alamat, siswa.kode_kelas as kode_kelas FROM siswa where nis=$nis");
                  foreach ($sql as $data){
                    $nis = $data['nis'];
              ...
              <form role="form" action="proses_edit.php" method="POST">
                <div class="card-body text-dark">
                  <div class="input-group">
                    <input type="text" hidden="hidden" class="form-control" id="disableTextInput" name="nis_lama" value="<?php echo "$nis" ?>">
                  </div>
          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <tr>
                  <?php 
                    ...
                    $sql = mysqli_query($connect, "SELECT * FROM siswa limit 10");
              ...
              <a href="siswa/" class="btn btn-info mt-3">Lihat Seluruh Siswa . . . . .</a>
              </div><!-- /.card-body -->
            </div>
            <!-- /.card -->
          </section>
